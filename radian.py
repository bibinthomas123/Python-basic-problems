...
print("the degree of {0} radian is :{1:.2f}".format(radian,degree)) # the format is used to insert a value into the sting instead of concatination  where {0} indicate the first variable inside the .format and {1} for the second var in the .format 
